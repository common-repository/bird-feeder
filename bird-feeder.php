...
*/
			if (function_exists('curl_init') && $postUrl) {
				...
				$getUrl = "http://api.bit.ly/shorten?version=2.0.1&longUrl=".$encodedUrl."&login=birdfeeder&apiKey=R_3a1855d37bcd5ebeb539f88fd29d6e23";
				...
				$shortnameHash = json_decode(curl_exec($session));
				curl_close($session);
